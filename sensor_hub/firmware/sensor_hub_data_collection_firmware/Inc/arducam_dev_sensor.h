...
#define OV2640_SENSOR_ID_HIGH  0x0A
#define OV2640_SENSOR_ID_LOW   0x0B
...
const SensorRegValPair OV2640_JPEG_INIT[]  =
{
  { 0xff, 0x00 },
  { 0x2c, 0xff },
  { 0x2e, 0xdf },
...
const SensorRegValPair OV2640_YUV422[]  =
{
  { 0xFF, 0x00 },
  { 0x05, 0x00 },
  { 0xDA, 0x10 },
...
const SensorRegValPair OV2640_JPEG[]  =
{
  { 0xe0, 0x14 },
  { 0xe1, 0x77 },
  { 0xe5, 0x1f },
...
const SensorRegValPair OV2640_320x240_JPEG[]  =
{
  { 0xff, 0x01 },
  { 0x12, 0x40 },
  { 0x17, 0x11 },
...
const SensorRegValPair OV2640_1600x1200_JPEG[]  =
{
  {0xff, 0x01},
  {0x11, 0x01},
